                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form action="" method="post">
                                <div class="field">
                                    <label class="label">Data produk</label>
                                    <div class="control has-icons-left">
                                        <div class="select">
                                            <select name="id_produk">
                                                <?php foreach ($produk as $row) : ?>
                                                    <option value="<?= $row["id_produk"] ?>" <?php if ($data["id_produk"] == $row["id_produk"]) : ?> selected="selected" <?php endif; ?>>
                                                        <?= $row["nm_produk"] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        ...
                                        <input class="input" type="text" placeholder="Nilai untuk setiap produk" name="nilai" value="<?= $data["nilai"] ?>">
